...
const CONFIG_COLUMNS =
  'provider, model, api_key, system_prompt, is_active, auto_reply_enabled, auto_reply_max_per_conversation, handoff_agent_id, embeddings_api_key, booking_alert_phone'
...
export async function loadAiConfig(
  ...
  return {
    ...
    embeddingsApiKey,
    bookingAlertPhone: row.booking_alert_phone,
  }
}

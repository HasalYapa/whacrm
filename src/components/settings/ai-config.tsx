...
export function AiConfig() {
  ...
  const [bookingAlertPhone, setBookingAlertPhone] = useState('');
  ...
  const fetchConfig = useCallback(async () => {
    ...
    try {
      ...
      if (data.configured) {
        ...
        setBookingAlertPhone(data.booking_alert_phone ?? '');
  ...
  const buildBody = () => ({
    ...
    booking_alert_phone: bookingAlertPhone.trim() || null,
  });
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="ai-booking-alert">{t('bookingAlertPhone')}</Label>
              <p className="text-xs text-muted-foreground">
                {t('bookingAlertPhoneDesc')}
              </p>
              <Input
                id="ai-booking-alert"
                value={bookingAlertPhone}
                onChange={(e) => setBookingAlertPhone(e.target.value)}
